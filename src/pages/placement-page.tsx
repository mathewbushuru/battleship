    ...
    <div className="px-6 py-6">
      ...
      <div className="mt-4 flex flex-wrap justify-center gap-y-2 sm:justify-between sm:px-12 lg:justify-center lg:gap-x-12">
        ...
        <ShipSelectorIcon
          name="Destroyer"
          cells={3}
          isActive={currentShip === "Destroyer"}
        ...
        <ShipSelectorIcon
          name="Submarine"
          cells={3}
          isActive={currentShip === "Submarine"}
        ...
        <ShipSelectorIcon
          name="Patroller"
          cells={2}
          isActive={currentShip === "Patroller"}
